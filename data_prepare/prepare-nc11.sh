...
PROJ_DIR="$HOME/workspace/fairseq"
OUTPUT_DIR="$PROJ_DIR/data-prepare/nc11de-en"
...
cat "${OUTPUT_DIR}/nc-v11/training-parallel-nc-v11/news-commentary-v11.de-en.en" \
  > "${OUTPUT_DIR}/train.en"
cat "${OUTPUT_DIR}/nc-v11/training-parallel-nc-v11/news-commentary-v11.de-en.de" \
  > "${OUTPUT_DIR}/train.de"
...
# Remove raw data
rm ${OUTPUT_DIR}/nc-v11.tgz ${OUTPUT_DIR}/dev.tgz ${OUTPUT_DIR}/test.tgz
rm -r ${OUTPUT_DIR}/nc-v11 ${OUTPUT_DIR}/dev ${OUTPUT_DIR}/test
