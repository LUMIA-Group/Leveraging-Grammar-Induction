...
@register_model_architecture("transformer", "transformer_nc11_de_en")
def transformer_nc11_de_en(args):
    transformer_iwslt_de_en(args)


@register_model_architecture("transformer", "transformer_aspec_ch_ja")
def transformer_aspec_ch_ja(args):
    base_architecture(args)

    
@register_model_architecture("transformer", "transformer_wmt17_en_tr")
def transformer_wmt17_en_tr(args):
    transformer_iwslt_de_en(args)


@register_model_architecture("transformer", "transformer_wmt19_en_kk")
def transformer_wmt19_en_kk(args):
    transformer_iwslt_de_en(args)
